...
typedef struct			s_dble
{
	char			sign;/*+ or -*/
	char			*s_div;
	char			d_bit[1024];/1.~ + 1023/
	char			*s_mod;
	char			m_bit[1076];/*1022+1+52=1075 because 2^-1023*1.~*/
	size_t			d_len;
	size_t			m_len;
	char			*out;
	int			d_idx;/*index until 0div*/
	int			m_idx;
	char			*e;
	char			esign;
	int			e_int;
...
{
	char			s[1076];/*512 only integer, 1075 only decimal*/
	size_t			len;/*integer(2^1024)'s length is 309*/
}				t_deci;
